...
from transform_in import AddHorizontalFlip3D, SigmoidForPred
from ops import DistMaps3D, ScaleLayer, BatchImageNormalize3D
...
class BasePredictor(object):
    def __init__(self,
        ...
        if with_flip:
            self.transforms.append(AddHorizontalFlip3D())
